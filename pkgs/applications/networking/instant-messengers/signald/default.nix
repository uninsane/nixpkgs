...
let
  ...
  src = fetchFromGitLab {
    ...
    repo = pname;
    rev = version;
    sha256 = "sha256-3P1AkrQ9tvI4pSCrMQCNu/WmrQvlN3pA4KJdjZCDn9U=";
  };
  ...
  deps = stdenv.mkDerivation {
    ...
    outputHash = {
      x86_64-linux = "sha256-LmCmV8Tvka6zXOM0YUo+joU4nzZ3NVREkOI+xuSoYwY=";
      aarch64-linux = lib.fakeHash;  # TODO: UPDATE
